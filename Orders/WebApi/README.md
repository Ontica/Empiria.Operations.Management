# Empiria Orders and Requisitions Management - Web Api Module

HTTP/JSON web api used to interact with the Empiria Orders
and Requisitions Management System's backend.
