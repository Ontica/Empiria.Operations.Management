/* Empiria Operations ****************************************************************************************
*                                                                                                            *
*  Module   : Orders Management                          Component : Tests Helpers                           *
*  Assembly : Empiria.Orders.Tests.dll                   Pattern   : Testing constants                       *
*  Type     : TestingConstants                           License   : Please read LICENSE.txt file            *
*                                                                                                            *
*  Summary  : Provides testing constants for Empiria Order Management modules.                               *
*                                                                                                            *
************************* Copyright(c) La Vía Óntica SC, Ontica LLC and contributors. All rights reserved. **/

namespace Empiria.Tests.Orders {

  /// <summary>Provides testing constants for Empiria Order Management modules.</summary>
  static public class TestingConstants {
    ...
    static internal string CONTRACT_BUDGET_ACCOUNT_UID = "ee8b6b23-659d-6d4b-91da-6ea587fbcb1f";
