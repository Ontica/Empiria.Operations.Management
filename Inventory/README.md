# Sistema de administración de inventarios y del activo fijo

Este repositorio contiene los módulos del *backend* del **Sistema de administración de inventarios y del activo fijo**.
...
El *backend* del **Sistema de administración de inventarios y del activo fijo** se conforma de los siguientes módulos:
...
Copyright © 2002-2026. La Vía Óntica SC, Ontica LLC y autores.
