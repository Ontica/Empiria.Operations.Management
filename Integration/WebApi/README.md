# Empiria Integrated Operations Management - Web Api Module

HTTP/JSON web api used to interact with the Empiria Integrated
Operations Management System's backend.
